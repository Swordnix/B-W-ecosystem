    ...
    var spriteImages = {
     ...
     spriteImages.sylkens.src = ["https://drive.google.com/uc?id=1mcx1DKhDoF6JHrXqXopOZoMgndAwTe9W", ""][alt]
            ...
            this.update = function() {
                ...
                if (this.hunger >= this.maxHunger) {
                    ...
                    if (nearestPrey) {
                        ...
                        // Check if distance is below 100
                        if (distance < 100) {
                ...
                this.killModeActivated = false;
                this.target = {x:this.x+((Math.random()*100)), y:0}
                }
  ...
  /* requirements.jssi 
        >>>every entities, in order to work, need to have their update() function run in a loop.

        >>> !! the images are loaded in from google drive. This module therefore is not independent. !!
